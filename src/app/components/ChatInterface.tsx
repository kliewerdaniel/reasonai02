    ...
    <div className="flex flex-col h-full">
      ...
      >
          ...
          <div className="text-center py-10">
            ...
            <div className="mt-8 grid gap-6 max-w-lg mx-auto sm:grid-cols-2">
              <div className="p-4 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
                <h3 className="font-medium text-gray-600 dark:text-gray-300 mb-2">Example Questions</h3>
                <ul className="space-y-2 text-sm text-gray-700 dark:text-gray-300">
                  <li className="cursor-pointer hover:text-gray-800 dark:hover:text-gray-100" onClick={() => setInput("What are the implications of quantum computing on cryptography?")}>
                    What are the implications of quantum computing on cryptography?
                  </li>
                  <li className="cursor-pointer hover:text-gray-800 dark:hover:text-gray-100" onClick={() => setInput("How might climate change impact global food security?")}>
                    How might climate change impact global food security?
                  </li>
                </ul>
              </div>
              <div className="p-4 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
                <h3 className="font-medium text-gray-600 dark:text-gray-300 mb-2">Capabilities</h3>
                <ul className="space-y-2 text-sm text-gray-700 dark:text-gray-300">
            ...
            >
              ...
              <div className={`relative max-w-[85%] md:max-w-[75%] ${message.role === "user" ? "ml-10" : "mr-10"}`}>
                ...
                <div 
                  ...
                  } opacity-0 group-hover:opacity-100 focus-within:opacity-100 transition-opacity text-xs text-gray-500 dark:text-gray-400 whitespace-nowrap`}
                  aria-hidden="true"
                >
        ...
        {isLoading && logs.length === 0 && (
          <div className="flex items-start mt-4">
            ...
            <div className="px-4 py-3 rounded-xl bg-white dark:bg-gray-800 dark:border dark:border-gray-700 shadow-sm">
      ...
      {showScrollButton && (
        <button
          ...
          className="absolute bottom-24 right-6 p-2 bg-gray-700 hover:bg-gray-800 text-white rounded-full shadow-lg z-20 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition-opacity opacity-90 hover:opacity-100"
      ...
      {/* Input Area - Enhanced */}
      <div className="border-t border-gray-200 dark:border-gray-800 p-3 sm:p-4 relative z-20 bg-white dark:bg-gray-900 shadow-md">
        <form onSubmit={handleSubmit} className="max-w-4xl mx-auto">
          {/* Model Selector */}
          <div className="mb-3 flex items-center">
            <label htmlFor="model-selector" className="text-sm font-medium text-gray-700 dark:text-gray-300 mr-3">
              Model:
            </label>
            <div className="relative flex-1 max-w-xs">
              <select
                ...
                className="block w-full pl-3 pr-10 py-2 text-sm rounded-lg border border-gray-300 dark:border-gray-700 
                          focus:outline-none focus:ring-2 focus:ring-gray-500 focus:border-transparent 
                          bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 shadow-sm appearance-none"
          ...
          <div className="flex items-end space-x-2 sm:space-x-3">
            <div className="flex-1 relative">
              <textarea
                ...
                className="w-full pl-4 pr-10 py-3 rounded-xl border border-gray-300 dark:border-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:border-transparent bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 resize-none min-h-[52px] max-h-[120px] text-sm sm:text-base shadow-sm"
            ...
            <button
              ...
              className="flex-shrink-0 p-3 sm:p-3.5 rounded-xl bg-gray-700 hover:bg-gray-800 text-white disabled:opacity-50 disabled:cursor-not-allowed transition-colors focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 shadow-sm"
